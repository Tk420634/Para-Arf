...
/datum/species/absol
	...
	bodyflags = HAS_SKIN_TONE | HAS_BODY_MARKINGS | HAS_TAIL | HAS_SKIN_COLOR
	dietflags = DIET_OMNI
...
/datum/species/anubis
	...
	species_traits = list(LIPS)
	clothing_flags = HAS_UNDERWEAR | HAS_UNDERSHIRT | HAS_SOCKS
	bodyflags = HAS_SKIN_TONE | HAS_BODY_MARKINGS | HAS_SKIN_COLOR
	dietflags = DIET_OMNI
	unarmed_type = /datum/unarmed_attack/punch
	blurb = "Placeholder."
	reagent_tag = PROCESS_ORG
...
/datum/species/beaver
	...
	species_traits = list(LIPS)
	clothing_flags = HAS_UNDERWEAR | HAS_UNDERSHIRT | HAS_SOCKS
	bodyflags =  HAS_BODY_MARKINGS | HAS_TAIL | HAS_SKIN_COLOR | HAS_SKIN_TONE
	dietflags = DIET_OMNI
	unarmed_type = /datum/unarmed_attack/punch
...
/datum/species/goat
	...
	species_traits = list(LIPS)
	clothing_flags = HAS_UNDERWEAR | HAS_UNDERSHIRT | HAS_SOCKS
	bodyflags = HAS_SKIN_TONE | HAS_BODY_MARKINGS | HAS_TAIL | HAS_SKIN_COLOR | HAS_HEAD_ACCESSORY
	dietflags = DIET_OMNI
	unarmed_type = /datum/unarmed_attack/punch
	blurb = "Placeholder."
	reagent_tag = PROCESS_ORG
