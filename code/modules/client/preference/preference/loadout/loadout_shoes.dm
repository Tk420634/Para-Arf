...
/datum/gear/shoes/jackboots
	display_name = "jack boots"
	cost = 2
	path = /obj/item/clothing/shoes/jackboots

/datum/gear/shoes/jacksandals
	display_name = "jack sandals"
	cost = 2
...
/datum/gear/shoes/griffin
	display_name = "griffin shoes"
	cost = 1
	path = /obj/item/clothing/shoes/griffin
	allowed_roles = list("Clown")

/datum/gear/shoes/sandalwhite
	display_name = "sandals, white"
	cost = 1
